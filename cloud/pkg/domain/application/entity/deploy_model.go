...
type ApplicationDeployInfo struct {
	...
	NodeId    int64     `gorm:"uniqueIndex:app_deploy;column:NodeId;not null"                json:"nodeId" binding:"required"`
	NodeName  string    `gorm:"column:NodeName;size:255;not null"                            json:"nodeName" binding:"required"`
